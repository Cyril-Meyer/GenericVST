...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GenericVST Demo Installer\n"
      else:
        line="OutputBaseFilename=GenericVST Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GenericVST Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GenericVST installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GenericVST Demo installer\n"
     else:
       line="SetupWindowTitle=GenericVST installer\n"
