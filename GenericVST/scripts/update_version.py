...
def main():
  ...
  plistpath = scriptpath + "/resources/GenericVST-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GenericVST-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GenericVST-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GenericVST-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GenericVST-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/GenericVST.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/GenericVST.iss",inplace=1):
